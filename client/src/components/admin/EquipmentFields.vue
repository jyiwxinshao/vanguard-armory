...
import EquipmentImageUpload from './EquipmentImageUpload.vue';
...
const emit = defineEmits(['image-busy']);
...
<div class="admin-create-fields">
          ...
          <EquipmentImageUpload v-model="form.image" :name="form.name" :error="errors.image" @busy="emit('image-busy', $event)" />
